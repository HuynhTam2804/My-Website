...
<body>
            ...
            <aside id="layout-menu" class="layout-menu menu-vertical menu bg-menu-theme">
                <div class="app-brand demo">
                    <a href="/" class="app-brand-link">
                        ...
                        <span class="app-brand-text menu-text fw-bolder ms-2">MT Website</span>
                    </a>
                ...
                <ul class="menu-inner py-1">
                    <!-- Dashboard -->
                    <li class="menu-item active" onclick="handleItemClick(this)">
                    ...
                    <li class="menu-item" onclick="handleItemClick(this)">
                        <a href="/" class="menu-link">
                            ...
                            <div data-i18n="Account Settings">ProductTypes</div>
                        </a>
                    </li>
                    <li class="menu-item" onclick="handleItemClick(this)">
                        <a href="/" class="menu-link">
                    ...
                    <div class="navbar-nav-right d-flex align-items-center" id="navbar-collapse">
                        ...
                        <ul class="navbar-nav flex-row align-items-center ms-auto">
                            ...
                            <li class="nav-item lh-1 me-3">
                                <a href="/" data-size="large" data-show-count="true"
                    ...
                    <footer class="content-footer footer bg-footer-theme">
                        <div
                            ...
                            <div class="mb-2 mb-md-0">
                                ...
                                , made with ❤️ by
                                <a href="" class="footer-link fw-bolder">MT
                                    Website</a>
                            </div>
                            <div>
    ...
    <div class="buy-now">
        <a href="https://github.com/HuynhTam2804/My-Website/" target="_blank" class="btn btn-danger btn-buy-now">MT
            Website</a>
    </div>
