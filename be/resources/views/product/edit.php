                    ...
                    <div class="card-body">
                        <form method="POST" action="" enctype="multipart/form-data">
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-10">
                                    <input type="text" name="name" value="{{ $SP->name }}" class="form-control" id="basic-default-name" placeholder=" " />
                                </div>
                            </div>
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-10">
                                    <select  name="product_types_id" class="form-select" id="exampleFormControlSelect1" aria-label="Default select example">
                                        @foreach ($LSP as $loaiSanPham)
                                            <option value="{{ $loaiSanPham->id }}" @if( $loaiSanPham->id == $SP->product_types_id) selected @endif>{{ $loaiSanPham->name }}</option>
                                        @endforeach
                                    </select>
                                </div>
                            </div>
                            ...
                            <div class="row mb-3">
                                <label class="col-sm-2 col-form-label" for="basic-default-company">Change Image</label>
                                <div class="col-sm-10">
                                    <input id="images" type="file" multiple name="images[]" multiple value="{{ $SP->mages }}" class="form-control"/>
                                </div>
                            </div>
