                                    ...
                                    <tbody>
                                        <tr>
                                            <td className="cart__product__item">
                                                <img src="cart/img/shop-cart/cp-1.jpg" alt="" />
                                        ...
                                        <tr>
                                            <td className="cart__product__item">
                                                <img src="cart/img/shop-cart/cp-2.jpg" alt="" />
                                                <div className="cart__product__item__title">
                                        ...
                                        <tr>
                                            <td className="cart__product__item">
                                                <img src="cart/img/shop-cart/cp-3.jpg" alt="" />
                                                <div className="cart__product__item__title">
                                                    <h6>Black jean</h6>
                                                    <div className="rating">
                                                        <i className="fa fa-star"></i>
                                        ...
                                        <tr>
                                            <td className="cart__product__item">
                                                <img src="cart/img/shop-cart/cp-4.jpg" alt="" />
                                                <div className="cart__product__item__title">
                                                    <h6>Cotton Shirt</h6>
                                                    <div className="rating">
                                                        <i className="fa fa-star"></i>
